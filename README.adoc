...
A simple, small template engine based loosely on the _FreeMarker_ syntax. _FreshMarker_ is implemented in Java 17 (Java 21 since version 1.0.0) and supports the `java.time` API and Records.
