== Adding _FreshMarker_

Add _FreshMarker_ as a dependency from _Maven Central_ to your project.
...
----
implementation 'de.schegge:freshmarker:{project-version}'
----
...
.Mill
[source,scala,role="secondary",subs="attributes+"]
----
ivy"de.schegge:freshmarker:{project-version}"
----
