...
[#variable-scope-feature,reftext=Variable Scope Feature]
===== Variable Scope Feature (since 1.9.0)
...
===== Partial Reduction Features (since 1.9.1)
...
[#security-feature,reftext=Partial Reduction Features]
===== Security Features (since 1.9.1)

A constant controls this feature in the `SecurityFeature` class.
