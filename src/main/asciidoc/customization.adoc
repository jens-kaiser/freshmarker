...
==== With Features (since 1.6.10)

The `with` and `without` Methods can be used to modify the behaviour of FreshMarker.
The value of the methods is a feature constant to activate or deactivate the corresponding feature.

===== Include Directive Features

Diese Features werden durch Konstanten in der Klasse IncludeDirectiveFeature gesteuert.
