...
Since _FreshMarker 1.6.3_ model types can _overload_ these operators. Therefore, they are not only available for numeric types, but also for the version and the temporal types and custom types can _overload_ them too.
