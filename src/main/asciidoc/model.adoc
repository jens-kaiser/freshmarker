...
[horizontal]
`lower..inclusive`:: Right-limited range with inclusive bound
`lower..<exlusive`:: Right-limited range with exclusive bound
`lower..*length`:: Length limited range
`lower..`::  Right-unlimited range
