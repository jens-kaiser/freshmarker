...
This built-in converts a boolean to the string using the `toString()` method of the corresponding base types `BigDecimal`, `BigInteger`, `Double`, `Float`, `Long`, `Integer`, `Byte` or `Short`.
