...
| *SET_AS_SEQUENCE*
| Feature that enables Set instances as sequences. This does not affect sets that are recognized as `SequencedCollection`.
| `false`

| *COLLECTION_AS_SEQUENCE*
| Feature that enables Collection instances as sequences. This does not affect collections that are recognized as `SequencedCollection`.
| `false`
|===
