...
This built-in formats the numbers between 1 and 9 as localized strings 'one' to 'nine' and values from 1000 are written according to the `CompactNumberFormat` with the style `LONG`.
