...
public class MappingTemplateObjectProvider implements TemplateObjectProvider {
  ...
  public MappingTemplateObjectProvider(MappingTemplateObjectProvider mappingTemplateObjectProvider) {
    mapper = new HashMap<>(mappingTemplateObjectProvider.mapper);
  }
