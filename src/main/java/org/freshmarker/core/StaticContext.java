...
public record StaticContext(ExtensionRegistry registry, BuiltInRepository builtIns, Map<Class<? extends TemplateObject>, Formatter> formatter, Map<String, OutputFormat> outputs,
                            ...
                            Map<String, TemplateFunction> functions, BuiltInVariableProvider builtInVariableProviders) {
    public StaticContext(ExtensionRegistry registry, Map<Class<? extends TemplateObject>, Formatter> combinedFormatters) {
        this(registry, registry.getBuiltIns(), combinedFormatters, registry.getOutputFormats(), registry.getProviders(),
                registry.getUserDirectives(), registry.getFunctions(), registry.getBuiltInVariableProviders());
    }
}