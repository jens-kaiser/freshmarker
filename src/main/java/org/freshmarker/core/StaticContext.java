...
public record StaticContext(ExtensionRegistry registry, ModelSecurityGateway modelSecurityGateway, Map<BuiltInKey, BuiltIn> builtIns, Map<Class<? extends TemplateObject>, Formatter> formatter, Map<String, OutputFormat> outputs,
    ...
    public StaticContext(ExtensionRegistry registry, ModelSecurityGateway modelSecurityGateway, TemplateLoader templateLoader) {
        this(registry, modelSecurityGateway, registry.getBuiltIns(), registry.getFormatterRegistry(), registry.getOutputFormats(), registry.getProviders(modelSecurityGateway),
