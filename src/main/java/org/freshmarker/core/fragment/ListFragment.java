...
public class ListFragment implements Fragment {
  ...
  public void process(ProcessContext context) {
    ...
    TemplateLoopValue loopValue = new TemplateLoopValue(looper);
    ListEnvironent listEnvironment = new ListEnvironent(context.getEnvironment(), identifier, looperIdentifier, looper, loopValue);
